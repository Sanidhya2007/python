...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\Dell\Downloads\face recognition images\stu 4.jpeg")
        ...
        atten_roll=ttk.Entry(left_inside_frame,width=22,font=("times new roman",11,"bold"))
        ...
        atten_name=ttk.Entry(left_inside_frame,width=22,font=("times new roman",11,"bold"))
        ...
        atten_dep=ttk.Entry(left_inside_frame,width=22,font=("times new roman",11,"bold"))
        ...
        atten_time=ttk.Entry(left_inside_frame,width=22,font=("times new roman",11,"bold"))
        ...
        atten_date=ttk.Entry(left_inside_frame,width=22,font=("times new roman",11,"bold"))
        ...
        self.atten_status=ttk.Combobox(left_inside_frame,width=20,font=("times new roman",11,"bold"),state='readonly')
        ...
        import_btn=Button(btn_frame,text="Import csv" ,width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")
        import_btn.grid(row=0,column=0)

        export_btn=Button(btn_frame,text="Export csv",width=17,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
