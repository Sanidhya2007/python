...
class Student:
    def __init__(self,root):
        ...
        # phone no
        phone_label=Label(class_Student_frame,text="",font=("times new roman",13,"bold"),bg="white")
        ...
        # Teacher name
        teacher_label=Label(class_Student_frame,text="",font=("times new roman",13,"bold"),bg="white")
        ...
        save_btn=Button(btn_frame,text="save",width=17,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Update",width=17,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Delete",width=17,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text="Reset",width=17,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        ...
        Search_btn=Button(btn_frame,text="Search",width=12,font=("times new roman",12,"bold"),bg="blue")
