...
class Student:
    def __init__(self,root):
        ...
        img_left=Image.open(r"C:\Users\Dell\Downloads\face recognition images\stu5.jpeg")
        ...
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=17,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=17,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=17,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3)
        
        btn_frame1=Frame(class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=235,width=715,height=35)

        take_photo_btn=Button(btn_frame1,text="Take photo Sample",width=35,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0)

        update_photo_btn=Button(btn_frame1,text="Update photo Sample",width=35,font=("timesnew roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\Dell\Downloads\face recognition images\stu7.jpg")
        ...
        Search_label=Label(Search_frame,text="Search By:",relief=RIDGE,font=("times new roman",12,"bold"),bg="red",fg="white")
    ...
    def add_data(self):
     if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
        ...
        try:
            ...
            print("query executed with values:")
            conn.commit()
            self.fetch_data()
...
# ============get cursor=============
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get() == "":
            ...
            try:
                Update=messagebox.askyesno("Update","Do you want to update your student details",parent=self.root)
                if Update>0:
                    conn=sqltor.connect(host="localhost", user="root", password='MySQL@12#', database="face_recognizer_1")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Div=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()        
                messagebox.showinto("delete","Successfully deleted student details",parent=self.root)
            except Exception as es:
                messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)    
